package com.woniu.openglesdemo.demo08;
 ...
 */
public class OpenGLES2Activity08 extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mGLSurfaceView.setRenderer(new MyRenderer(this.getResources()));
        //RenderMode 有两种
    ...
    static class MyRenderer implements GLSurfaceView.Renderer {
        ...
        private static final String VERTEX_SHADER2 = "attribute vec4 vPosition;\n"
...
//        };
        ...
        public void onSurfaceChanged(GL10 unused, int width, int height) {
            ...
            int vertexShader2 = loadShader(GLES20.GL_VERTEX_SHADER, VERTEX_SHADER);
            //加载 shader 代码
            int fragmentShader2 = loadShader(GLES20.GL_FRAGMENT_SHADER, FRAGMENT_SHADER);
            //attatch shader 代码
            GLES20.glAttachShader(mProgram, vertexShader2);
            //attatch shader 代码
            GLES20.glAttachShader(mProgram, fragmentShader2);
            //链接 shader 代码
...
//            Matrix.frustumM(mProjectionMatrix, 0, -ratio, ratio, -1, 1, 3, 7);
            ...
            Matrix.frustumM(mProjectionMatrix, 0, -1, 1, -ratio2, ratio2, 3, 7);
